...
INSERT INTO books_details VALUE
(1,"DBMS","balguru swamy",495.00,"2005","v5"),
(2,"Data Structure","Padma reddy",595.00,"2017","v6"),
(3,'jungle book', 'Rudyard kipling', 600.00, '2021', 'v6');
SELECT * FROM books_details;
SELECT Book_Id, Book_Name, Author_Name FROM books_details;
SELECT * FROM books_details WHERE Publish_Year = '2020';
SELECT * FROM books_details WHERE Publish_Year >= '2021';
SELECT * FROM books_details WHERE Publish_Year >= '2021' AND Book_Price <= 600;
SELECT * FROM books_details WHERE Publish_Year >= '2020' OR Book_Price >= 600;
SELECT * FROM books_details WHERE Publish_Year >= '2020' AND Book_Price <= 500 AND Author_Name = "balguru swamy";
...
ALTER TABLE books_details ADD COLUMN No_Of_Pages INT AFTER Book_Name;
...
(2,"Data Structure","Padma reddy",595.00,"2017","v6"),
(3,'jungle book', 'Rudyard kipling', 600.00, '2021', 'v6'),
(4, 'jungle book' , 'rudyard kipling' , 501.00, '2010', 'v9');
...
ALTER TABLE Book_Details MODIFY Book_Details VARCHAR(35) NOT NULL;

SELECT DISTINCT Book_Details Book_Author FROM Book_Details;
